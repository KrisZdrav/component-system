interface testemonialBasicSingleProps {
  imgUrl: string;
  text: string;
  name: string;
  position: string;
...
const testemonialBasicSingle: React.FC<testemonialBasicSingleProps> = ({
  imgUrl,
  text,
  name,
  position,
  ...
  return (
    <div className="bg-white pb-16 pt-24 sm:pb-24 sm:pt-32 xl:pb-32">
      <div
        style={{ backgroundColor: bgColor ? bgColor : "#110909" }}
...
export default testemonialBasicSingle;
